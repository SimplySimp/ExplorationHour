var BattleScene = new Phaser.Class({
    ...
    {    
        ...
        this.cameras.main.setBackgroundColor("rgba(139, 194, 55, 0.5)");
        this.startBattle();
    ...
    startBattle: function() {
        ...
        var warrior = new PlayerCharacter(this, 50, 50, "player", 3, "Alphonso", 50, randomDamage() );        
        ...
        var Wolf1 = new Enemy(this, 250, 75, "Wolf1", null, "Wolf 1", 50, 15);
        this.add.existing(Wolf1);
